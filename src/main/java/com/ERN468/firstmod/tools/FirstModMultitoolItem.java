...
public class FirstModMultitoolItem extends MiningToolItem {
        ...
        public FirstModMultitoolItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
