...
public class FirstModBowBase extends BowItem {
    public double bowDamage;

    public FirstModBowBase(double damage, Settings settings) {
        super(settings);
        bowDamage = damage;
    }
            ...
            if (!itemStack.isEmpty() || bl) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!world.isClient) {
                        ...
                        persistentProjectileEntity.setDamage(persistentProjectileEntity.getDamage() + bowDamage);
